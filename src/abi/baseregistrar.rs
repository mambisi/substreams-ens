...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GracePeriod {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct MigrationLockPeriod {}
    impl MigrationLockPeriod {
        const METHOD_ID: [u8; 4] = [107u8, 27u8, 209u8, 197u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for MigrationLockPeriod {
        const NAME: &'static str = "MIGRATION_LOCK_PERIOD";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MigrationLockPeriod {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl AcceptRegistrarTransfer {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::FixedBytes(self.label.as_ref().to_vec()),
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for NameExpires {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PreviousRegistrar {}
    impl PreviousRegistrar {
        const METHOD_ID: [u8; 4] = [171u8, 20u8, 236u8, 89u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for PreviousRegistrar {
        const NAME: &'static str = "previousRegistrar";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for PreviousRegistrar {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl Register {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.owner)),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    self.duration.clone().to_signed_bytes_be().as_slice(),
                )),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Register {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TransferPeriodEnds {}
    impl TransferPeriodEnds {
        const METHOD_ID: [u8; 4] = [74u8, 224u8, 93u8, 167u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for TransferPeriodEnds {
        const NAME: &'static str = "transferPeriodEnds";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TransferPeriodEnds {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl ControllerAdded {
        const TOPIC_ID: [u8; 32] = [
            10u8, 139u8, 179u8, 21u8, 52u8, 192u8, 237u8, 70u8, 243u8, 128u8, 203u8, 134u8, 123u8,
            213u8, 200u8, 3u8, 161u8, 137u8, 206u8, 217u8, 167u8, 100u8, 227u8, 11u8, 58u8, 73u8,
            145u8, 169u8, 144u8, 29u8, 116u8, 116u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl ControllerRemoved {
        const TOPIC_ID: [u8; 32] = [
            51u8, 216u8, 57u8, 89u8, 190u8, 37u8, 115u8, 245u8, 69u8, 59u8, 18u8, 235u8, 157u8,
            67u8, 179u8, 73u8, 155u8, 197u8, 125u8, 150u8, 189u8, 47u8, 6u8, 123u8, 164u8, 72u8,
            3u8, 200u8, 89u8, 232u8, 17u8, 19u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl NameMigrated {
        const TOPIC_ID: [u8; 32] = [
            234u8, 61u8, 126u8, 17u8, 149u8, 161u8, 93u8, 45u8, 220u8, 216u8, 89u8, 176u8, 26u8,
            189u8, 76u8, 107u8, 150u8, 15u8, 169u8, 249u8, 38u8, 78u8, 73u8, 154u8, 112u8, 169u8,
            12u8, 127u8, 12u8, 100u8, 183u8, 23u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl NameRegistered {
        const TOPIC_ID: [u8; 32] = [
            179u8, 217u8, 135u8, 150u8, 61u8, 1u8, 178u8, 246u8, 132u8, 147u8, 180u8, 189u8, 177u8,
            48u8, 152u8, 143u8, 21u8, 126u8, 164u8, 48u8, 112u8, 212u8, 173u8, 132u8, 15u8, 238u8,
            4u8, 102u8, 237u8, 147u8, 112u8, 217u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl NameRenewed {
        const TOPIC_ID: [u8; 32] = [
            155u8, 135u8, 160u8, 14u8, 48u8, 241u8, 172u8, 101u8, 216u8, 152u8, 240u8, 112u8,
            248u8, 163u8, 72u8, 143u8, 230u8, 5u8, 23u8, 24u8, 45u8, 10u8, 32u8, 152u8, 225u8,
            180u8, 185u8, 58u8, 84u8, 170u8, 155u8, 214u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
