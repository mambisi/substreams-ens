            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.wrapped_owner),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.resolver),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
        ...
        impl SetMetadataService {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.new_metadata_service),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl SetUpgradeContract {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.upgrade_address),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::FixedBytes(self.labelhash.as_ref().to_vec()),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.new_registrant),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.new_controller),
                        ),
