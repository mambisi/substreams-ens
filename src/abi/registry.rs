...
pub mod functions {
    ...
    impl Owner {
        const METHOD_ID: [u8; 4] = [2u8, 87u8, 27u8, 227u8];
    ...
    impl Resolver {
        const METHOD_ID: [u8; 4] = [1u8, 120u8, 184u8, 191u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for Resolver {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Resolver {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl SetOwner {
        const METHOD_ID: [u8; 4] = [91u8, 15u8, 201u8, 195u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl SetSubnodeOwner {
        const METHOD_ID: [u8; 4] = [6u8, 171u8, 89u8, 35u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl Ttl {
        const METHOD_ID: [u8; 4] = [22u8, 162u8, 92u8, 189u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for Ttl {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Ttl {
...
pub mod events {
    ...
    impl NewOwner {
        const TOPIC_ID: [u8; 32] = [
            206u8, 4u8, 87u8, 254u8, 115u8, 115u8, 31u8, 130u8, 76u8, 194u8, 114u8, 55u8, 97u8,
            105u8, 35u8, 81u8, 40u8, 193u8, 24u8, 180u8, 157u8, 52u8, 72u8, 23u8, 65u8, 124u8,
            109u8, 16u8, 141u8, 21u8, 94u8, 130u8,
        ];
    ...
    impl substreams_ethereum::Event for NewOwner {
    ...
    impl NewResolver {
        const TOPIC_ID: [u8; 32] = [
            51u8, 87u8, 33u8, 176u8, 24u8, 102u8, 220u8, 35u8, 251u8, 238u8, 139u8, 107u8, 44u8,
            123u8, 30u8, 20u8, 214u8, 240u8, 92u8, 40u8, 205u8, 53u8, 162u8, 201u8, 52u8, 35u8,
            159u8, 148u8, 9u8, 86u8, 2u8, 160u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for NewResolver {
    ...
    impl NewTtl {
        const TOPIC_ID: [u8; 32] = [
            29u8, 79u8, 155u8, 191u8, 201u8, 202u8, 184u8, 157u8, 102u8, 225u8, 161u8, 86u8, 47u8,
            34u8, 51u8, 204u8, 191u8, 19u8, 8u8, 203u8, 79u8, 99u8, 222u8, 46u8, 173u8, 87u8,
            135u8, 173u8, 221u8, 184u8, 250u8, 104u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl substreams_ethereum::Event for NewTtl {
    ...
    impl Transfer {
        const TOPIC_ID: [u8; 32] = [
            212u8, 115u8, 93u8, 146u8, 11u8, 15u8, 135u8, 73u8, 73u8, 21u8, 245u8, 86u8, 221u8,
            155u8, 84u8, 200u8, 243u8, 9u8, 2u8, 96u8, 112u8, 202u8, 234u8, 92u8, 115u8, 114u8,
            69u8, 21u8, 37u8, 100u8, 210u8, 102u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
